# STM32U5G9J-DK2 TouchGFX Benchmark Project

This project is used to generate **benchmark results (Matrices)** on the **STM32U5G9J-DK2** board using **TouchGFX**.
...
```bash
git clone https://github.com/Silicon-Signals/stm32u5g9j-dk2-touchgfx-benchmark.git
```
...
- **Open the Project in STM32CubeIDE**
  ...
  - Open **STM32CubeIDE**.
  - Navigate to the project folder: `stm32u5g9j-dk2-touchgfx-benchmark/STM32CubeIDE/`
  - Open the .project file in STM32CubeIDE.
