...
const uint8_t* video_Big_Buck_Bunny_mjpeg_bin_start;
const uint8_t* video_lake_800_480_bin_start;
...
void setupVideoDecoder(touchgfx::HAL& hal)
{
    ...
    setupVideo(static_cast<touchgfx::HALSDL2&>(hal).localFileName(videoFileName, 400, "Big_Buck_Bunny_mjpeg.bin"), &video_Big_Buck_Bunny_mjpeg_bin_start, video_Big_Buck_Bunny_mjpeg_bin_length);
    setupVideo(static_cast<touchgfx::HALSDL2&>(hal).localFileName(videoFileName, 400, "lake_800_480.bin"), &video_lake_800_480_bin_start, video_lake_800_480_bin_length);
}
...
void setupSimulator(int argc, char** argv, touchgfx::HAL& hal)
{
    ...
    static_cast<touchgfx::HALSDL2&>(hal).setWindowTitle("STM32U5G9-DK2-Benchmark");
